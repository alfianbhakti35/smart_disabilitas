                ...
                <div class="card-body">
                    <form method="post" action="/matkul/{{ $matkul->id }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" placeholder="Nama mata kuliah" class="form-control  @error('nama') is-invalid @enderror" value="{{ old('nama', $matkul->nama) }}" autofocus>
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            @foreach ($user as $user)
                                 @if (old('user_id', $user->name)) == $user->id)
                        ...
                        <div class="form-group">
                            ...
                            @foreach ($prodi as $prodi)
                                    @if (old('prodi_id', $prodi->nama)) == $prodi->id)
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="semester" id="semester" placeholder="semester" min="1" max="8" class="form-control  @error('semester') is-invalid @enderror" value="{{ old('semester', $matkul->semester) }}">
                            @error('semester')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
